            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Создать учетную запись</h5>
                  ...
                  <form class="row g-3 needs-validation" novalidate method="POST" action="/register">
                    ...
                    <div class="col-12">
                      <label for="yourEmail" class="form-label">Ваша почта</label>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <div class="invalid-feedback">Пожалуйста, выберите имя пользователя.</div>
                      </div>
                    </div>
